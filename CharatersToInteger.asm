...
;--------------------------------------------------------------------------------------------------------------------------------
; required register starting states  
...
;        	      the reuse of the conversion algorithm that makes this possible for intergers. The algorithm is as follows:
...
; 		          you do this by subtracting 30h from the ascii charaters.
